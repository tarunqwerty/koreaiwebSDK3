(function(KoreSDK){
    ...
    botOptions.JWTUrl = "http://localhost:8080/api/users/getJWT";
    botOptions.userIdentity = 'yadav.tarun21@gmail.com';// Provide users email id here
    botOptions.botInfo = { name: "WebSDK", "_id": "st-b767db1e-8276-55c5-b578-f40acc260939" }; // bot name is case sensitive
    ...
    **/
    botOptions.clientId = "cs-b01b8ac1-adc6-5797-b0eb-a767df441782";
    botOptions.clientSecret = "suFOuPt7byEVAIGXnFrnpXFkJ1j5XXAUwieI7HSB1W0=";
